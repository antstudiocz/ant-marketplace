...
| Role | Model | Effort |
|---|---|---|
| Integration owner | `gpt-6-luna` | High |
| Strong reviewer or strong judgment | `gpt-6-astra` | Medium |
| Bounded investigation, validation, or narrow work | `gpt-6-luna` | High, Medium, or Low as proportionate |
