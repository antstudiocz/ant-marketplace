...
7. Apply the selected verification cadence, then verify the selected outcome evidence and realistic states. Final candidate review findings or subsequent tracked mutations require affected re-review and refreshed evidence. Freeze one exact candidate and verify one risk-appropriate broad gate.
