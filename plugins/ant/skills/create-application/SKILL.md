...
2. Check the requester's local development environment, especially whether they can run Git, Docker, and at least one TypeScript-capable package manager/runtime path such as Bun or Node/npm.
