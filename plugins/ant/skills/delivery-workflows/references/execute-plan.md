...
- `/ant:delivery-workflows https://docs.google.com/document/d/xxx` → use that URL
- `/ant:delivery-workflows /path/to/plan.md` → use that file path
- `/ant:delivery-workflows` (no argument) → ask the user
