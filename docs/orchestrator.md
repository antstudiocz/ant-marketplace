...
Every child receives a complete capsule: exact model/profile and effort, fresh isolated context, outcome and acceptance, selected outcome evidence and realistic states required by the [shared evidence and quality policy](../plugins/ant/skills/implementation-orchestrator/references/lifecycle.md#evidence-and-quality), non-goals, write ownership, checks, root-only plan boundary, delegation permission, and reporting/escalation path. Children remain capped at High.
